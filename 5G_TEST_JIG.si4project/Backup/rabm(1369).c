...
PORT_STS	port_sts[16] = {
		{ GPIO_BAT_DCHG, BAT_DCHG_PIN, 0, 0, 2, 0},
		{ GPIO_BAT_CHG, BAT_CHG_PIN, 0, 0, 2, 0},
		{ GPIO_BAT_NFB, BAT_NFB_PIN, 0, 0, 2, 0},		
		{ GPIO_BAT_PWR, BAT_PWR_PIN, 0, 0, 2, 0},
		{ GPIO_AC_FAIL, AC_FAIL_PIN, 0, 0, 2, 0},
